...
# original:
# http://www.willmcgugan.com/blog/tech/2007/4/25/going-sub-pixel-with-pygame/

# slightly modified, leif theden, 2010
...
class SubPixelSurface(object):
    ...
    def _generate(s, frac_x, frac_y):        
        ...
        pygame_surface = pygame.image.frombuffer(rgba_data, a.shape[:2][::-1], "RGBA")
